...
mouse_grapher <- function(df, intensity, ms_code, time_window = 500, span = 7, threshold = 0.65, result = "both") {
  ...
  if(result == "both"){
    ...
    ggplot(mtcars, aes(wt, mpg)) +  
      theme_minimal()+
      annotate("Mouse has no recorded values")
  }
}
```
...
p3 <- mouse_grapher(wt_ko_sheets, intensity = "p0.6" , ms_code = "078" , span = 7, threshold = 0.575, time_window = 300, result = "plot")
p4 <- mouse_grapher(wt_ko_bwaves, intensity = "p0.6", ms_code = "078", result = "plot", time_window = 899)
