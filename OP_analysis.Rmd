...
ko_bwave_path <- "/Users/ryanhecht/RStudio/OP_data/data/b-trace_KO scotopic.xlsx"
...
wt_bwaves <- mk_header(wt_bwave_path,"E1:U1", "B2:D2", "B2:V1822", rm_sheets = c(1,2))
```
...
#mice <- mice[!(mice %in% c("141", "113", "138", "145", "078"))]
...
```{r}
mouse_grapher(wt_ko_sheets, intensity = "p0.6" , ms_code = "078" , span = 7, threshold = 0.575, time_window = 300, result = "plot")
