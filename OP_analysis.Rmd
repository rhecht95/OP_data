...
```{r}
# mouse_grapher(wt_ko_sheets, intensity = -1.59 , ms_code = "050" , span = 7, threshold = 0.575, time_window = 300, result = "plot")
# mouse_grapher(wt_ko_sheets, intensity = -1.59 , ms_code = "050" , span = 7, threshold = 0.59, time_window = 300, result = "table")
```
